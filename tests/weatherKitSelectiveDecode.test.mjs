...
const [{ default: WeatherKit2 }, { Weather }, { Response }] = await Promise.all([import("../src/class/WeatherKit2.mjs"), import("@nsringo/weatherkit"), import("../src/process/Response.mjs")]);
