export default {
	WeatherKit: {
		...
		Configs: {
			...
			AirQuality: { ColorfulClouds: ["CN", "HK", "MO"], QWeather: ["AD", "BE", "BG", "CA", "CN", "HR", "CZ", "DK", "FI", "FR", "DE", "GI", "GR", "HK", "HU", "IE", "JP", "KR", "LV", "LT", "MO", "MT", "NL", "MK", "NO", "PL", "PT", "RO", "RS", "SG", "SK", "SI", "ES", "SE", "CH", "TW", "TH", "GB", "US"] },
		},
	},
	Default: {
